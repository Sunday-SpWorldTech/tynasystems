...
- A private Staff Login button is available in public navigation and footer.
- Staff Dashboard includes a live Activity feed for registrations, logins, dashboard visits, checkout attempts, purchases, downloads, contact submissions, support actions, and staff actions.
