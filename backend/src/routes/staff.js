...
async function buildWallet() {
  ...
  return { currency: PLATFORM_CURRENCY, grossUSD: gross, feeUSD: fee, completedWithdrawalsUSD: completedWithdrawals, pendingWithdrawalsUSD: pendingWithdrawals, availableUSD: available, paidOrders: paidOrders.length, withdrawals: withdrawals.map(publicWithdrawal), transactions: companyCredits.slice(0, 100) };
}
